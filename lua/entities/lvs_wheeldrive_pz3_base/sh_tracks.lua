...
if SERVER then
	...
	function ENT:TracksCreate( PObj )
		...
		local L2 = self:AddWheel( { hide = true, wheeltype = LVS.WHEELTYPE_LEFT, pos = Vector(65,50,32), mdl = WheelModel } )
		local L3 = self:AddWheel( { hide = true, wheeltype = LVS.WHEELTYPE_LEFT, pos = Vector(20,50,35), mdl = WheelModel } )
		local L4 = self:AddWheel( { hide = true, wheeltype = LVS.WHEELTYPE_LEFT, pos = Vector(-20,50,33), mdl = WheelModel } )
		local L5 = self:AddWheel( { hide = true, wheeltype = LVS.WHEELTYPE_LEFT, pos = Vector(-40,50,37), mdl = WheelModel } )
		...
		local R2 = self:AddWheel( { hide = true, wheeltype = LVS.WHEELTYPE_RIGHT, pos = Vector(65,-50,32), mdl = WheelModel } )
		local R3 = self:AddWheel( { hide = true, wheeltype = LVS.WHEELTYPE_RIGHT, pos = Vector(20,-50,35), mdl = WheelModel } )
		local R4 = self:AddWheel( { hide = true, wheeltype = LVS.WHEELTYPE_RIGHT, pos = Vector(-20,-50,33), mdl = WheelModel } )
		local R5 = self:AddWheel( { hide = true, wheeltype = LVS.WHEELTYPE_RIGHT, pos = Vector(-40,-50,37), mdl = WheelModel } )
		...
		local LeftTracksArmor = self:AddArmor( Vector(0,50,47), Angle(0,0,0), Vector(-100,-15,-40), Vector(115,15,5), 1100, self.FrontArmor )
		...
		local RightTracksArmor = self:AddArmor( Vector(0,-50,47), Angle(0,0,0), Vector(-100,-15,-40), Vector(115,15,5), 1100, self.FrontArmor )
