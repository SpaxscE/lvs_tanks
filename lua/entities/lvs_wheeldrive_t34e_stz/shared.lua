...
ENT.MDL = "models/diggercars/t34/t34e_stz.mdl"
...
function ENT:InitWeapons()
	...
	weapon.OnSelect = function( ent )
		ent:TurretUpdateBallistics( ent.ProjectileVelocityCoaxial, "muzzle_turret" )
	end
